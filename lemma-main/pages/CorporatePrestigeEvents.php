...
<html lang="en">
  <head>
    ...
    <title>Corporate Prestige Events</title>
  ...
  <body>
    ...
    <?php
$videoSrc = "../assets/Images/EventsPhotos/corporate.mp4"; // Video file for the header
...
?>
    ...
    <section class="Services">
      <!-- Decoration -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/Prestige_decor.jpg" alt="Decoration" />
        <div class="content">
          ...
          <a href="corporateprestige.decor.php">Explore Details</a>
        </div>
      </div>

      <!-- Photography -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/prestige_photographer.webp" alt="Photography" />
        <div class="content">
      ...
      <!-- Food -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/prestige_food.jpg" alt="Food" />
        <div class="content">
      ...
      <!-- Clothes -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/prestige_outfit.webp" alt="Clothes" />
        <div class="content">
          ...
          <a href="corporateprestige.attire.php">Explore Details</a>
        </div>
      </div>

      <!-- Event Location -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/prestige_venue.jpg" alt="Event Location" />
        <div class="content">
