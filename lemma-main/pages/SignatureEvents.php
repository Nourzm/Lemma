...
<html lang="en">
  ...
  <body>
    <!-- Header Section -->
    <?php
$videoSrc = "../assets/Images/EventsPhotos/standard.mp4"; // Video file for the header
...
?>
    ...
    <section class="Services">
      <!-- Decoration -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/standard_deco.jpg" alt="Decoration" />
        <div class="content">
      ...
      <!-- Photography -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/standard_photographer.webp" alt="Photography" />
        <div class="content">
          ...
          <a href="Photography.html">Explore Details</a>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="content">
          ...
          <a href="EventStaffing.html">Explore Details</a>
        </div>
      </div>

      <!-- Food -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/standard_food.avif" alt="Food" />
        <div class="content">
          ...
          <a href="GourmetCulinary.html">Explore Details</a>
        </div>
      </div>

      <!-- Clothes -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/standard_outfit.jpeg" alt="Clothes" />
        <div class="content">
      ...
      <!-- Event Location -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/standard_venue.jpg" alt="Event Location" />
        <div class="content">
          ...
          <a href="venuselection.html">Explore Details</a>
        </div>
