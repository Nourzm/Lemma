...
<html lang="en">
  ...
  <body>
    ...
    <?php
$videoSrc = "../assets/Images/EventsPhotos/Baby.mp4"; // Video file for the header
...
?>
    ...
    <section class="Services">
      <!-- Decoration -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/baby_deco.png" alt="Decoration" />
        <div class="content">
          ...
          <a href="babyarrival.decor.php">Explore Details</a>
        </div>
      </div>

      <!-- Photography -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/baby_photographer.jpg" alt="Photography" />
        <div class="content">
      ...
      <!-- Food -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/baby_food.jpg" alt="Food" />
        <div class="content">
      ...
      <!-- Clothes -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/baby_clothes.webp" alt="Clothes" />
        <div class="content">
          ...
          <a href="babyarrival.attire.php">Explore Details</a>
        </div>
      </div>

      <!-- Event Location -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/baby_venue.jpeg" alt="Event Location" />
        <div class="content">
