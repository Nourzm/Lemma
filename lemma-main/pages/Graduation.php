...
<html lang="en">
  ...
  <body>
    ...
    <?php
$videoSrc = "../assets/Images/EventsPhotos/graduation.mp4"; // Video file for the header
...
?>
    ...
    <section class="Services">
      <!-- Decoration -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/graduation_decor.webp" alt="Decoration" />
        <div class="content">
          ...
          <a href="graduation.decor.php">Explore Details</a>
        </div>
      </div>

      <!-- Photography -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/graduation_photography.png" alt="Photography" />
        <div class="content">
      ...
      <!-- Food -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/graduation_food2.jpg" alt="Food" />
        <div class="content">
      ...
      <!-- Clothes -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/graduation_outfit.jpg" alt="Clothes" />
        <div class="content">
          ...
          <a href="graduationattire.php">Explore Details</a>
        </div>
      </div>

      <!-- Event Location -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/graduation_venue.jpeg" alt="Event Location" />
        <div class="content">
