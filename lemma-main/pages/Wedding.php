...
<html lang="en">
  ...
  <body>
    <!-- Header Section -->
    <?php
$videoSrc = "../assets/Images/EventsPhotos/wedding2.mp4"; // Video file for the header
...
?>
    ...
    <section class="Services">
      <!-- Decoration -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/weddingdeco.jpeg" alt="Decoration" />
        <div class="content">
          ...
          <a href="wedding.decor.php">Explore Details</a>
        </div>
      </div>
      ...
      <div class="section">
        <img
          src="../assets/Images/EventsPhotos/Wedding_photographer_at_work.jpg"
          alt="Photography"
        />
        <div class="content">
      ...
      <!-- Food -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/weddingfood.jpg" alt="Food" />
        <div class="content">
      ...
      <!-- Clothes -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/wedding_outfit.jpg" alt="Clothes" />
        <div class="content">
          ...
          <a href="wedding.attire.php">Explore Details</a>
        </div>
      </div>

      <!-- Event Location -->
      <div class="section">
        <img src="../assets/Images/EventsPhotos/weddingvenue.jpeg" alt="Event Location" />
        <div class="content">
