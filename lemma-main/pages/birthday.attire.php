...
<body>
    ...
    $imageBackground = "../assets/Images/AttireImages/Images3/img0.jpg"; // No image background
    $serviceName = "Birthday Attire"; // Title of the service
        ...
        <section id="types-of-events">
            ...
            <div class="cards-area">
                ...
                <div class="card" onclick="openPopup(20)"
                    ...
                    data-img="../assets/Images/AttireImages/Images3/img1.jpg">

                    <img src="../assets/Images/AttireImages/Images3/img1.jpg" />

                    <div class="overlay">

                        <h3>Soft White Outfit</h3>
                ...
                <div class="card" onclick="openPopup(21)"
                    ...
                    data-img="../assets/Images/AttireImages/Images3/img2.jpg">

                    <img src="../assets/Images/AttireImages/Images3/img2.jpg" />

                    <div class="overlay">
                        <h3>Classy Black Outfit</h3>
                ...
                <div class="card" onclick="openPopup(22)"
                    ...
                    <img src="../assets/Images/AttireImages/Images3/img3.jpg" />

                    <div class="overlay">

                        <h3>Refreshing Floral Style Outfit</h3>
                ...
                <div class="card" onclick="openPopup(23)"
                    data-img="../assets/Images/AttireImages/Images3/img4.jpg">
                    <img src="../assets/Images/AttireImages/Images3/img4.jpg" />
                    <div class="overlay">
                        <h3>Other Colors Outfits</h3>
